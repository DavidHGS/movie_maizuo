<template>
  <div class="main">
    <div class="center-view" data-enter-time="1584364486">
      <div
        class="avatar"
        data-enter-time="1584364486"
        data-click-fun="track_f_176881"
      >
        <img
      ...
      <ul class="my-order-tab">
        <li data-enter-time="1584364486" data-click-fun="track_f_493864">
          <img
        ...
        <li data-enter-time="1584364486" data-click-fun="track_f_231168">
          <img
      ...
      >
        ...
        <span class="value"
          ><span class="price-decimal price-fmt"
            ><i>￥</i> <span class="interge" style="font-size: 15px;">0</span>
